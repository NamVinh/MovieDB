...
import { IMG_API, API_KEY, MOVIE_API } from '../Constants';
		...
		return (
			<Modal {...props} size='lg' aria-labelledby='contained-modal-title-vcenter' centered>
				...
				<Modal.Body style={{ backgroundColor: '#000000' }}>
					<ReactPlayer className='container-fluid' url={youtubeUrl + video} playing width='100%'></ReactPlayer>
				</Modal.Body>
			</Modal>
		);
	};
			...
			return (
				<li className='list-inline-item' key={index}>
					<button type='button' className='btn btn-outline-info'>
						<Link style={{ textDecoration: 'none', color: '#ffffff' }} to={`/genre/${genre.id}`}>
							{genre.name}
						</Link>
					</button>
				</li>
		...
		<div>
				...
				<div className='container'>
					<div className='row' style={{ color: 'white', padding: '1rem' }}>
						<div className='col-sm-6 col-lg-4  m-4 '>
							...
							<div className='btn-play'>
								<FontAwesomeIcon
									icon={faPlayCircle}
									size='6x'
									style={{ color: 'white', cursor: 'pointer', order: 1 }}
						...
						<div className=' col-md-10 col-xl-6 justify-content-center align-content-center d-flex flex-column '>
							...
							<ReactStars count={details.vote_average} size={24} color={'#f4c10f'}></ReactStars>
			...
			<div className='container'>
				...
				<div className='person-container'>
					{' '}
					<ListPerson fetchUrl={MOVIE_API + idMovie + '/credits' + API_KEY} />
				</div>
